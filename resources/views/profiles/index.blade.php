                            ...
                            <div class="bg-white shadow-md rounded-lg overflow-hidden">
                                ...
                                <div class="p-4">
                                    ...
                                    <p>
                                        ...
                                        <a href="{{ route('alumni.projects.index', ['alumni' => $profile->user_id]) }}"
                                            class="mt-4 flex justify-center  px-2 py-3 bg-blue-500 text-white font-semibold rounded-lg shadow-md hover:bg-blue-600 transition duration-300 ease-in-out">
                                            View Projects
                                        </a>
                                </div>
                            </div>
