            ...
            <div class="w-full">
                ...
                <div class="card mt-3 bg-white shadow-md rounded-lg overflow-hidden">
                    <div class="card-header bg-gray-100 p-4 border-b border-gray-200 flex justify-between items-center">
                        ...
                        <a href="{{ url('roles/create') }}" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded">
                                    ...
                                    @foreach ($roles as $role)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap flex space-x-2">
                                                <a href="{{ url('roles/'.$role->id.'/give-permissions') }}" class="bg-yellow-500 hover:bg-yellow-700 text-white font-bold py-2 px-4 rounded">
