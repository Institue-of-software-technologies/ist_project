<nav x-data="{ open: false }" class="bg-white border-b border-gray-400 shadow-lg sticky top-0 z-10">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button
                            class="inline-flex items-center px-3 py-2 border border-transparent text-2xl leading-4 font-medium rounded-md text-white bg-gray-900 hover:text-gray-200 focus:outline-none transition ease-in-out duration-150">
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @endcan
            @can('view alumni job')
                <x-responsive-nav-link :href="url('alumni/jobs')" :active="request()->routeIs('jobs')">
                    {{ __('Jobs') }}
                </x-responsive-nav-link>
            @endcan
        </div>
