<x-app-layout>
    <div class="bg-gray-100 justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-2xl lg:max-w-4xl mx-auto w-full bg-white shadow-lg rounded-lg overflow-hidden">
            ...
            <div class="text-left mt-7 m-5">
                ...
                <div class="grid sm:grid-cols-1 lg:grid-cols-2">
                    ...
                    <a href="mailto:{{ $profile->email }}"><i class="far fa-envelope text-xl"></i>
                        {{ $profile->email }}</a>
                    <a href="tel:{{ $profile->phone }}><strong class="text-gray-700"><i class="fas fa-phone"></i>
                        {{ __('Phone:') }}</strong> {{ $profile->phone }}</a>
                    <h2>
                    ...
                    <h2>
                        <a href="{{ $profile->social_media_links }}" target="_blank"
        ...
        @else
            <p class="text-gray-700">{{ __('You have not created a profile yet.') }} <a
