    ...
    <div class="bg-gray-100 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-3xl w-full bg-white shadow-md rounded-lg overflow-hidden">
            ...
            <div class="profile-body p-6">
                ...
                <form method="POST" action="{{ route('alumni.profile.update', $profile->id) }}"
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div>
                                ...
                                <input type="email" name="email" id="email"
                                    value="{{ old('email', $profile->email) }}" class="mt-1 block w-full">
                            </div>
                            <div>
                                <label for="phone"
                                    class="block text-sm font-medium text-gray-700">{{ __('Phone') }}</label>
                                <input type="text" name="phone" id="phone"
                                    value="{{ old('phone', $profile->phone) }}" class="mt-1 block w-full">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="step hidden" id="step2">
                        <div class="grid grid-cols-1 gap-6">
                            <div>
                                <label for="degree"
                                    class="block text-sm font-medium text-gray-700">{{ __('Degree') }}</label>
                                <input type="text" name="degree" id="degree"
                                    value="{{ old('degree', $profile->degree) }}" class="mt-1 block w-full">
                            </div>
                            <div>
                                <label for="graduation_year"
                                    class="block text-sm font-medium text-gray-700">{{ __('Graduation Year') }}</label>
                                <input type="number" name="graduation_year" id="graduation_year"
                                    value="{{ old('graduation_year', $profile->graduation_year) }}" required
                                    class="mt-1 block w-full">
                            </div>
                            <div>
                                <label for="extra_course"
                                    class="block text-sm font-medium text-gray-700">{{ __('Extra Course') }}</label>
                                <input type="text" name="extra_course" id="extra_course"
                                    value="{{ old('extra_course', $profile->extra_course) }}"
                                    class="mt-1 block w-full">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            <div>
                                <label for="current_job_title"
                                    class="block text-sm font-medium text-gray-700">{{ __('Current Job Title') }}</label>
                                <input type="text" name="current_job_title" id="current_job_title"
                                    value="{{ old('current_job_title', $profile->current_job_title) }}"
                                    class="mt-1 block w-full">
                            </div>
                            <div>
                                <label for="current_employer"
                                    class="block text-sm font-medium text-gray-700">{{ __('Current Employer') }}</label>
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            <div>
                                ...
                                <input type="text" name="location" id="location"
                                    value="{{ old('location', $profile->location) }}" class="mt-1 block w-full">
                            </div>
                            <div>
                                <label for="linkedin_profile"
                                    class="block text-sm font-medium text-gray-700">{{ __('LinkedIn Profile') }}</label>
                            ...
                            <div>
                                <label for="social_media_links"
                                    class="block text-sm font-medium text-gray-700">{{ __('Instagram Link') }}</label>
                                <input type="text" name="social_media_links" id="social_media_links"
                                    value="{{ old('social_media_links', $profile->social_media_links) }}"
                                    class="mt-1 block w-full">
                            </div>
                            <div>
                                ...
                                @if ($profile->profile_photo)
                                    <img src="{{ asset('storage/' . $profile->profile_photo) }}"
                                        ...
                                        class="w-32 h-32 mx-auto rounded-full shadow-md mt-2">
                                @endif
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center justify-between mt-4">
                        ...
                        <button type="submit"
                            class="w-64 bg-red-600 text-white py-2 px-4 rounded-md shadow-sm hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 hidden"
                            id="submitBtn">
                            {{ __('Update Profile') }}
                        </button>
                    </div>
