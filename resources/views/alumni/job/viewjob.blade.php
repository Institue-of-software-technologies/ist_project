<x-app-layout>
    <div class="container mx-auto mt-2 px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                <div class="bg-white border border-lg border-gray-300 hover:border-gray-500 rounded-lg overflow-hidden mt-4 p-4">
                    <div class="p-4 border-b border-gray-200">
                        ...
                        <hr>
                        <span class="md:inline-flex hidden items-center px-3 py-0.5 mt-3 rounded-full text-xs md:text-sm font-normal bg-red-100 text-red-500 capitalize mr-2">
                            New
            ...
            @can('apply job')
                <div>
                    <div class="bg-white border border-lg border-gray-300 hover:border-gray-500 shadow-md rounded-lg overflow-hidden mt-4 p-4">
                        <a class="bg-red-500 hover:bg-red-700 text-white text-2xl font-bold my-auto px-4 rounded float-right" href="{{ route('alumni.job.index') }}">Back</a>
                        <form action="{{ route('job-applications.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-4">
                                <label for="experience" class="block text-xl font-medium text-gray-700">Years of Experience</label>
                                <select id="experience" name="experience" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                                    @for ($i = 1; $i <= 20; $i++)
                            ...
                            {{-- <div class="mb-4">
                                <label for="salary" class="block text-xl font-medium text-gray-700">Monthly Salary Expectation (Gross)</label>
                                <input type="number" id="salary" name="salary" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                            </div> --}}

                            <div class="mb-4">
                                <label for="cover_letter" class="block text-xl font-medium text-gray-700">Cover Letter</label>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="file" id="cv" name="cv" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                            </div>
                            ...
                            <div class="mb-4">
                                <label for="linkedin" class="block text-xl font-medium text-gray-700">LinkedIn Profile</label>
                                <input type="url" id="linkedin" name="linkedin" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                            </div>

                            <div class="mb-4">
                                <label for="education" class="block text-xl font-medium text-gray-700">Education</label>
                                <input type="text" id="education" name="education" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                            </div>
                            ...
                            <div class="flex justify-end">
                                <button type="submit" class="bg-red-600 text-white px-4 py-2 rounded-md shadow-sm">Submit Application</button>
                            </div>
                        </form>
                    </div>
                </div>
